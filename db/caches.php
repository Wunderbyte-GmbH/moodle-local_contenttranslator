...
/**
 * Cache definitions for local_contenttranslator.
 *
...
$definitions = [
    // Render time lookups: (sourcehash, language, tenant) => translation data, including negative entries.
    'translations' => [
    ...
    // Effective configuration per course (target languages, enabled flag, visibility).
    'courseconfig' => [
        'mode' => cache_store::MODE_APPLICATION,
        'simplekeys' => true,
        'simpledata' => true,
